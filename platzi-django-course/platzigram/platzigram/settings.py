...
SECRET_KEY = '69()3ycj8z+1rm3w7&(do(v7w7)xkq8cgu#nc7!ff=eo&rupg)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates') # all apps will share this template folder
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
